...
Constants.apiRoot = 'https://localhost:6001';
Constants.clientRoot = 'https://localhost:5003';
Constants.stsAuthority = 'https://localhost:5001';
Constants.clientId = 'angularClient';
...
/* harmony import */ var _auth_core_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./auth/core.module */ "./src/app/auth/core.module.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [], imports: [[
            ...
            _auth_core_module__WEBPACK_IMPORTED_MODULE_10__["CoreModule"],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"],
        ...
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _auth_core_module__WEBPACK_IMPORTED_MODULE_10__["CoreModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"]] }); })();
...
/* harmony import */ var _auth_service_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./auth-service.component */ "./src/app/auth/auth-service.component.ts");
...
class AuthInterceptorService {
    ...
    intercept(req, next) {
        if (req.url.startsWith(_Constants__WEBPACK_IMPORTED_MODULE_4__["Constants"].apiRoot)) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(this._authService.getAccessToken().then(token => {
                const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]().set('Authorization', `Bearer ${token}`);
                const authReq = req.clone({ headers });
                return next.handle(authReq).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(_ => { }, error => {
                    var respError = error;
...
AuthInterceptorService.ɵfac = function AuthInterceptorService_Factory(t) { return new (t || AuthInterceptorService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_auth_service_component__WEBPACK_IMPORTED_MODULE_5__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AuthInterceptorService, [{
    ...
    }], function () { return [{ type: _auth_service_component__WEBPACK_IMPORTED_MODULE_5__["AuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] }]; }, null); })();


/***/ }),

/***/ "./src/app/auth/auth-service.component.ts":
/*!************************************************!*\
  !*** ./src/app/auth/auth-service.component.ts ***!
  \************************************************/
...
class AuthService {
    constructor(_httpClient) {
        ...
        this._loginChangedSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this.loginChanged = this._loginChangedSubject.asObservable();
        const stsSettings = {
            authority: _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].stsAuthority,
            client_id: _Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].clientId,
            redirect_uri: `${_Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].clientRoot}signin-callback`,
            scope: 'openid profile api1',
            response_type: 'code',
            post_logout_redirect_uri: `${_Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].clientRoot}signout-callback`,
            automaticSilentRenew: true,
            silent_redirect_uri: `${_Constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].clientRoot}assets/silent-callback.html`
            // metadata: {
        ...
        this._userManager = new oidc_client__WEBPACK_IMPORTED_MODULE_1__["UserManager"](stsSettings);
...
/* harmony import */ var _auth_interceptor_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth-interceptor.service */ "./src/app/auth/auth-interceptor.service.ts");
/* harmony import */ var _auth_service_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./auth-service.component */ "./src/app/auth/auth-service.component.ts");
...
CoreModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function CoreModule_Factory(t) { return new (t || CoreModule)(); }, providers: [
        _auth_service_component__WEBPACK_IMPORTED_MODULE_3__["AuthService"],
        { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HTTP_INTERCEPTORS"], useClass: _auth_interceptor_service__WEBPACK_IMPORTED_MODULE_2__["AuthInterceptorService"], multi: true }
    ], imports: [[]] });
...
class FetchDataComponent {
    constructor(http) {
        http.get(_Constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].apiRoot + '/weatherforecast').subscribe(result => {
            this.forecasts = result;
        }, error => console.error(error));
    }
}
FetchDataComponent.ɵfac = function FetchDataComponent_Factory(t) { return new (t || FetchDataComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
...
const _c4 = function () { return ["/angular-info"]; };
...
NavMenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NavMenuComponent, selectors: [["app-nav-menu"]], decls: 21, vars: 24, consts: [[1, "navbar", "navbar-expand-sm", "navbar-toggleable-sm", "navbar-light", "bg-white", "border-bottom", "box-shadow", "mb-3"], [1, "container"], [1, "navbar-brand", 3, "routerLink"], ["type", "button", "data-toggle", "collapse", "data-target", ".navbar-collapse", "aria-label", "Toggle navigation", 1, "navbar-toggler", 3, "click"], [1, "navbar-toggler-icon"], [1, "navbar-collapse", "collapse", "d-sm-inline-flex", "justify-content-end", 3, "ngClass"], [1, "navbar-nav", "flex-grow"], [1, "nav-item", 3, "routerLinkActive", "routerLinkActiveOptions"], [1, "nav-link", "text-dark", 3, "routerLink"], [1, "nav-item", 3, "routerLinkActive"]], template: function NavMenuComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "Angular8Client");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](14, "Angular Information");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](15, "li", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](16, "a", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](17, "Counter");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](18, "li", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](19, "a", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](20, "Fetch data");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
module.exports = __webpack_require__(/*! F:\repos\IdentityServer5QuickStart\5_AspNetIdentity\AngularClient\ClientApp\src\main.ts */"./src/main.ts");
